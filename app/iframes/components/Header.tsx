...
import { Header, HeaderLogo, HeaderNav, HeaderGroup, SearchButton, ThemeToggle } from "@/registry/uisydesign/blocks/header"
...
export default function IFrameHeader() {
    ...
    return <Header justify="between">
        ...
        <HeaderGroup>
            <SearchButton kbds={["⌘", "K"]} className="!max-w-[190px]" />
            <ThemeToggle />
        </HeaderGroup>
    </Header>
